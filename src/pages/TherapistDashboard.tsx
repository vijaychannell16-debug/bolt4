...
function TherapistDashboard() {
  ...
  useEffect(() => {
    ...
    setRecentActivity([
      { id: 1, action: 'New appointment booked', patient: 'John Doe', time: '5 min ago', type: 'booking' },
      { id: 2, action: 'Session completed', patient: 'Sarah Johnson', time: '1 hour ago', type: 'session' },
      { id: 3, action: 'Message received', patient: 'Mike Wilson', time: '2 hours ago', type: 'message' },
      { id: 4, action: 'Progress report updated', patient: 'Emma Davis', time: '3 hours ago', type: 'report' }
    ]);
  }, []);
